...
When a task explicitly approves public profile publication, follow the credential and publication sections.

When waiting on concrete Kanban work, follow the dependency-gated waiting section.
